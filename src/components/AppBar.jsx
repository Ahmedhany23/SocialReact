...
const AppBarr = ({setshowmenu,showmenu}) => {
      ...
      <AppBar position="sticky">
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
            onClick={() => { setshowmenu(showmenu==="block"?"none":"block") ;}}
          >
            <MenuIcon />
          </IconButton>
          ...
          <Box sx={{ display: { xs: "none", md: "flex" } , alignItems:"center" , justifyItems:"center", gap:"10px" }}>
          
            <IconButton
              size="large"
              aria-label="show 4 new mails"
              color="inherit" sx={{width: "37px", height: "37px"}}
            >
              <Badge  badgeContent={4} color="error">
                <MailIcon  />
              </Badge>
            ...
            <IconButton 
              ...
              color="inherit"
            >
              <Avatar sx={{width: "37px", height: "37px"}} src="./imges/img1.jpg" />
            </IconButton>
          </Box>
